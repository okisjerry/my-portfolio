...
<!-- Mirrored from Awajiokinor.netlify.app/index-creative1 by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 09 Mar 2024 08:13:57 GMT -->
...
<head>
        ...
        <meta name="description" content="Awajiokinor Portfolio Template">
        <meta name="author" content="cosmos-themes">

        <title>Awajiokinor's - Portfolio </title>
        ...
        <section id="home" class="banner" style="background-image: url('images/background/home-banner-bg.jpg')" data-stellar-background-ratio=".7" data-scroll-index="0">
            <div class="container">
                ...
                <div class="banner-caption">
                    <h1>Hi! I'm Awajiokinor.</h1>
                    <p class="cd-headline clip mt-30">
                        <span>Creative Designer & Developer based in Nigeria.</span><br>
                        <span class="blc">Specialised in</span>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-5 col-md-6">
                        <!--About Image-->
                        <div class="about-img">
                            <img src="images/portfolioimage.jpg" alt="" >
                        </div>
                    </div>
                    <div class="col-lg-7 col-md-6">
                        ...
                        <div class="about-content">
                            <div class="about-heading">
                                <h2>About Me.</h2>
                                <span>Web & Mobile Apps Developer</span>
                            </div>
                            <p>I'm <b>Awajiokinor Ugwem Jeremiah</b> A passionate and versatile full-stack developer with 
                            five (5) years experince in the tech industry, dedicated to crafting exceptional digital experiences. </p>
                            <p>With a blend of creativity and technical expertise, I thrive on transforming innovative ideas into tangible solutions 
                                that drive results.
                                I believe in the power of collaboration and continuous learning, as I stay up-to-date with
                                the latest technologies and best practices.
                                Allow me to be the curator of that innovative idea you have.</p>
                            <!--About Social Icons-->
                            <div class="social-icons">
                                <a href="https://www.facebook.com/OkisJerry"><i class="fa fa-facebook"></i></a>
                                <a href="https://x.com/shugagurl_?s=11"><i class="fa fa-twitter"></i></a>
                                <a href="http://linkedin.com/in/awajiokinor-jeremiah-104479219"><i class="fa fa-linkedin"></i></a>
                            </div>
                            <!-- <span class="about-button">
                                <a class="main-btn" href="/Laravel/portfolios/cv.pdf" 
                                download="cv.pdf"> Download CV</a>
                            </span> -->
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col">
                        <div class="heading text-center">
                            <h6>Services</h6>
                            <h2>The services I offer include</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="service-item">
                            ...
                            <h4>Web Design</h4>
                            <p>Designing responsive and user-friendly websites is
                                what I delight in creating.
                            </p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        ...
                        <div class="service-item">
                            ...
                            <p>Not only do we specialise in web design, but also 
                                web applications that funcction just as great as an application.
                            </p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        ...
                        <div class="service-item">
                            ...
                            <p>An application that can be accessed by users, with a 
                                rsponsive design and interface
                            </p>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        ...
                        method='get'><input type='hidden' name='form-name' value='contactForm' />
                           @csrf
                        <div class="row">
                                ...
                                <div class="col-md-12 form-group">
                                    <!--message box-->
                                    <textarea class="form-control con-validate" id="contact-message" placeholder="How can we help you?" 
                                    rows=6 ></textarea>
                                </div>
                                <div class="col-md-12 text-center">
                                    <!--contact button-->
                                    <button type="button" onClick="javascript:document.forms[0].submit();" 
            ...
            <div class="container">
                <div class="row text-center">
                    ...
                    <div class="col-md-3 col-sm-6">
                        ...
                        <div class="contact-info">
                            <h5>Phone No.</h5>
                           <p> <i class="fa fa-mobile" aria-hidden="true"> <a href="tel:+2347068021492"> +234 7068021492</a></i> </p>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <!--Contant Item-->
                        <div class="contact-info">
                            <h5>Email</h5>
                            <p><a href="mailto:okisjeremiah@gmail.com">okisjeremiah@gmail.com</a> </p>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <!--Contant Item-->
                ...
                <div class="row text-center">
                    <div class="col-md-12">
                        <hr>
                        <p class="copy pt-30">
                            Awajiokinor &copy; 2024. All Right Reserved.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <script>
        function sendEmail(){
            Email.send({
                Host : "smtp.gmail.com",
                Username : "okisjeremiah@gmail.com",
                Password : "Excellenceiskey5",
                To : 'okisjeremiah@gmail.com',
...
<!-- Mirrored from Awajiokinor.netlify.app/index-creative1 by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 09 Mar 2024 08:14:26 GMT -->
</html>
